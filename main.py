...
class LocationButton(ListItemButton):
    ...
    deselected_colour = ListProperty()
...
class AddLocationForm(ModalView):
    ...
    def found_location(self, request, data):
        ...
        if type(data) is not dict:
            ...
            #self.error_message = "There was an error with your results."
            self.errorPopup("There was an error with your results.")
        elif data['cod'] == '404':
            #self.search_results.item_strings = ["There was an error with your results."]
            #self.error_message = "There was an error with your results."
            #self.error_pop.open()
            ...
            #self.search_results.item_strings = ["No results found."]
...
def locations_args_converter(index, data_item):
        ...
        #self.deselected_colour = [random.random() for i in range(3)]+[1]
        return {'location': (city, country),
                'deselected_color': [random.random() for i in range(3)]+[1]}
